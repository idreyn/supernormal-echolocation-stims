function [mask, focus_mask] = make_directional_headband(params, radius_m, notch_focus_offset_m, notch_focal_width_m, notch_heading_deg, thickness_m, notch_position_deg)
    arguments
    ...
    focus_angle = angle_from_heading(notch_position_deg);
    focus_x = cos(focus_angle) * notch_focus_distance_m;
    focus_y = sin(focus_angle) * notch_focus_distance_m;
    parabola = make_parabolic_mask(params, focus_x, focus_y, notch_focal_width_m, notch_position_deg + notch_heading_deg);
    mask(parabola == 1) = 0;
